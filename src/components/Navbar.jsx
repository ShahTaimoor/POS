...
const Navbar = () => {
  ...
  return (
    <div className="fixed mt-3 sm:mt-0 top-0 left-0 right-0 bg-white/30 backdrop-blur-md ring-1 ring-white/10 shadow-md z-30 px-4 py-3 flex flex-col lg:flex-row lg:items-center lg:justify-between gap-3">
