...
const BankReceipt = () => {
  const bankOptions = [
    ...
    'Bank Alfalah', 'Meezan Bank', 'National Bank of Pakistan'
  ];

  const customerOptions = [
    'Ali Autos', 'Ahmed Traders', 'CarPoint Lahore', 
    'AutoZone Karachi', 'Bilal & Co.', 'Mehran Autos'
  ];
          ...
          <div className="relative">
            <input
              ...
              className={`w-full px-4 py-3 rounded-lg border-2 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all ${
                bankName ? 'border-blue-300' : 'border-gray-300'
              }`}
            />
            <motion.div 
        ...
        <AnimatePresence>
          {showSuccess && (
            ...
            >
              ...
              <span className="font-medium">Receipt Saved Successfully!</span>
            </motion.div>
          )}
        </AnimatePresence>
      </div>
