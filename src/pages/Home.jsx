  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto space-y-8">
        {/* Date Range Filters */}
        <motion.div
          className="flex flex-col sm:flex-row sm:items-end gap-4 bg-white p-2  rounded-xl shadow-sm"
        ...
        >
          <div className='flex items-center'>
            ...
            >
              ...
              <input
                type="date"
                className="border-2 border-gray-200 rounded-lg px-4 py-2 w-[120px] focus:ring-2 focus:ring-blue-500 focus:border-transparent"
                value={fromDate}
          ...
          <motion.div className="w-full sm:w-auto">
            <motion.button
              ...
              className={`w-full sm:w-auto px-6 py-2 rounded-lg text-white font-medium shadow-md transition-all flex items-center justify-center ${isFiltering ? 'bg-blue-400' : 'bg-blue-600 hover:bg-blue-700'
                }`}
            >
              {isFiltering ? (
                <>
